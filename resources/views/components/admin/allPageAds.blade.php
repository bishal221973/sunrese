        ...
        <div class="col-xl-4 col-lg-4 col-md-4 mb-3">
            <div class="card p-4">
                <form action="{{ $ad->id ? route('ads.update', $ad) : route('ads.store') }}" method="POST"
                    ...
                    <input type="hidden" name="redirect" value="all" id="">
                    ...
                    <div class="form-group mb-2 {{ $ad->id ? 'd-none' : '' }}">
                        ...
                        <select name="location" class="my-input">
                            ...
                            @role('super-admin')
                                <option value="Below of Menu">Below of Menu</option>
                                <option value="Top of List">Top of List</option>
                                <option value="In-List 1">In-List 1</option>
                                <option value="In-List 2">In-List 2</option>
                                <option value="In-List 3">In-List 3</option>
                                <option value="In-List 4">In-List 4</option>
                                <option value="Top of Footer">Top of Footer</option>
                            @endrole
                            {{-- <option value="All page left">All page left</option> --}}
                            <option value="All page right">All page right</option>
                        </select>
                    </div>
